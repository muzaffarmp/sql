...
-- 4. Employees age between 30-40 OR Marketing dept
SELECT * FROM Employees
WHERE (Age BETWEEN 30 AND 40) OR DepartmentName = 'Marketing';

-- 5. Rows 11 to 20 from Employees, Salary DESC
SELECT * FROM Employees
ORDER BY Salary DESC
OFFSET 10 ROWS FETCH NEXT 10 ROWS ONLY;

-- 6. Products with Price <= 1000 and StockQuantity > 50, order by Stock
...
-- 5. Employees Age < 30 and dept in HR or IT
SELECT * FROM Employees
...
-- 7. Employees whose salary > ALL Sales dept employees
SELECT * FROM Employees
